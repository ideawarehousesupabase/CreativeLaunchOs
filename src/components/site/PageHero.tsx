  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-24 text-center">
        <span className="inline-block text-xs font-mono uppercase tracking-widest text-cyan">{eyebrow}</span>
        <h1 className="mt-5 font-display text-5xl md:text-6xl font-bold tracking-tight">{title}</h1>
