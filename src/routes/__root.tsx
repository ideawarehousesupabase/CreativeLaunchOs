...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered operating system that handles bookings, leads, projects and analytics for creators." },
      { name: "author", content: "Creative Launch OS" },
